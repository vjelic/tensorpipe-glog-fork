...
#include <tensorpipe/channel/hip_basic/channel_impl.h>
...
#include <tensorpipe/channel/hip_basic/constants.h>
#include <tensorpipe/channel/hip_basic/context_impl.h>
...
void ChannelImpl::cudaCopy(
    ...
    std::function<void(const Error&)> callback) {
  {
    ...
    TP_CUDA_CHECK(hipMemcpyAsync(dst, src, length, hipMemcpyDefault, stream));
  }
...
void ChannelImpl::allocateSendCpuBuffer(ChunkSendOpIter opIter) {
  ...
  Allocator& hipHostAllocator =
      context_->getCudaHostSendAllocator(op.deviceIdx);
  hipHostAllocator.alloc(
      op.length,
      callbackWrapper_(
