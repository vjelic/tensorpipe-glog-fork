...
IF(HIP_FOUND)
  ...
  set(TP_HIP_INCLUDE ${ROCM_PATH}/include ${ROCM_PATH}/rocm_smi/include ${TP_HIP_INCLUDE})
  set(TP_HIP_INCLUDE ${TP_HIP_INCLUDE} $<BUILD_INTERFACE:${PROJECT_SOURCE_DIR}> $<INSTALL_INTERFACE:include>)
ENDIF()
